...
static const _AddThreeInts_Event_type_support_symbol_names_t _AddThreeInts_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, srv, AddThreeInts_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tutorial_interfaces, srv, AddThreeInts_Event)),
  }
};
...
{
  return &::tutorial_interfaces::srv::rosidl_typesupport_cpp::AddThreeInts_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tutorial_interfaces, srv, AddThreeInts_Event)() {
  return get_message_type_support_handle<tutorial_interfaces::srv::AddThreeInts_Event>();
}
...
static const rosidl_service_type_support_t AddThreeInts_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<tutorial_interfaces::srv::AddThreeInts_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<tutorial_interfaces::srv::AddThreeInts_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<tutorial_interfaces::srv::AddThreeInts_Event>(),
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, tutorial_interfaces, srv, AddThreeInts)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<tutorial_interfaces::srv::AddThreeInts>();
}
