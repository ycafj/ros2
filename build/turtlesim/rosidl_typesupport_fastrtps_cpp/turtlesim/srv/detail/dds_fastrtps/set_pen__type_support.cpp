  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtlesim::srv::SetPen_Request;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_turtlesim
max_serialized_size_key_SetPen_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtlesim::srv::SetPen_Response;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_turtlesim
max_serialized_size_key_SetPen_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
// functions for turtlesim::srv::SetPen_Request already declared above

// functions for turtlesim::srv::SetPen_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_turtlesim
cdr_serialize(
  const turtlesim::srv::SetPen_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtlesim::srv::SetPen_Event & ros_message)
{
  // Member: info
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_turtlesim
max_serialized_size_SetPen_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        turtlesim::srv::typesupport_fastrtps_cpp::max_serialized_size_SetPen_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        turtlesim::srv::typesupport_fastrtps_cpp::max_serialized_size_SetPen_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtlesim::srv::SetPen_Event;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_turtlesim
max_serialized_size_key_SetPen_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        turtlesim::srv::typesupport_fastrtps_cpp::max_serialized_size_key_SetPen_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        turtlesim::srv::typesupport_fastrtps_cpp::max_serialized_size_key_SetPen_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const turtlesim::srv::SetPen_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<turtlesim::srv::SetPen_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetPen_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const turtlesim::srv::SetPen_Event *>(
...
static size_t _SetPen_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetPen_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SetPen_Event__callbacks = {
  "turtlesim::srv",
  "SetPen_Event",
...
static rosidl_message_type_support_t _SetPen_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetPen_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &turtlesim::srv::typesupport_fastrtps_cpp::_SetPen_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlesim, srv, SetPen_Event)() {
  return &turtlesim::srv::typesupport_fastrtps_cpp::_SetPen_Event__handle;
}
...
static const rosidl_service_type_support_t _SetPen__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetPen__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<turtlesim::srv::SetPen_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<turtlesim::srv::SetPen_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<turtlesim::srv::SetPen_Event>(),
