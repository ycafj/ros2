...
bool cdr_serialize_turtlesim__srv__SetPen_Request(
  const turtlesim__srv__SetPen_Request * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim
bool cdr_deserialize_turtlesim__srv__SetPen_Request(
  eprosima::fastcdr::Cdr & cdr,
  turtlesim__srv__SetPen_Request * ros_message)
{
  // Field name: r
  {
    cdr >> ros_message->r;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtlesim__srv__SetPen_Request;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim
bool cdr_serialize_key_turtlesim__srv__SetPen_Request(
  const turtlesim__srv__SetPen_Request * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: r
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim
size_t get_serialized_size_key_turtlesim__srv__SetPen_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetPen_Request__ros_msg_type * ros_message = static_cast<const _SetPen_Request__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim
size_t max_serialized_size_key_turtlesim__srv__SetPen_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const turtlesim__srv__SetPen_Request * ros_message = static_cast<const turtlesim__srv__SetPen_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_turtlesim__srv__SetPen_Request(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  turtlesim__srv__SetPen_Request * ros_message = static_cast<turtlesim__srv__SetPen_Request *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_turtlesim__srv__SetPen_Request(cdr, ros_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim
bool cdr_serialize_turtlesim__srv__SetPen_Response(
  const turtlesim__srv__SetPen_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim
bool cdr_deserialize_turtlesim__srv__SetPen_Response(
  eprosima::fastcdr::Cdr & cdr,
  turtlesim__srv__SetPen_Response * ros_message)
{
  // Field name: structure_needs_at_least_one_member
  {
    cdr >> ros_message->structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtlesim__srv__SetPen_Response;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim
bool cdr_serialize_key_turtlesim__srv__SetPen_Response(
  const turtlesim__srv__SetPen_Response * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: structure_needs_at_least_one_member
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim
size_t get_serialized_size_key_turtlesim__srv__SetPen_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetPen_Response__ros_msg_type * ros_message = static_cast<const _SetPen_Response__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim
size_t max_serialized_size_key_turtlesim__srv__SetPen_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const turtlesim__srv__SetPen_Response * ros_message = static_cast<const turtlesim__srv__SetPen_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_turtlesim__srv__SetPen_Response(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  turtlesim__srv__SetPen_Response * ros_message = static_cast<turtlesim__srv__SetPen_Response *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_turtlesim__srv__SetPen_Response(cdr, ros_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim
bool cdr_serialize_turtlesim__srv__SetPen_Event(
  const turtlesim__srv__SetPen_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_turtlesim__srv__SetPen_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_turtlesim__srv__SetPen_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim
bool cdr_deserialize_turtlesim__srv__SetPen_Event(
  eprosima::fastcdr::Cdr & cdr,
  turtlesim__srv__SetPen_Event * ros_message)
{
  // Field name: info
  {
  ...
  // Field name: request
  {
    ...
    auto array_ptr = ros_message->request.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_turtlesim__srv__SetPen_Request(cdr, &array_ptr[i]);
    }
  }
  ...
  // Field name: response
  {
    ...
    auto array_ptr = ros_message->response.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_turtlesim__srv__SetPen_Response(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtlesim__srv__SetPen_Event;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim
bool cdr_serialize_key_turtlesim__srv__SetPen_Event(
  const turtlesim__srv__SetPen_Event * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: info
  ...
  // Field name: request
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_turtlesim__srv__SetPen_Request(
        &array_ptr[i], cdr);
    }
  }
  ...
  // Field name: response
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_turtlesim__srv__SetPen_Response(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim
size_t get_serialized_size_key_turtlesim__srv__SetPen_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetPen_Event__ros_msg_type * ros_message = static_cast<const _SetPen_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: request
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_turtlesim__srv__SetPen_Request(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  // Field name: response
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_turtlesim__srv__SetPen_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlesim
size_t max_serialized_size_key_turtlesim__srv__SetPen_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_turtlesim__srv__SetPen_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Field name: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_turtlesim__srv__SetPen_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const turtlesim__srv__SetPen_Event * ros_message = static_cast<const turtlesim__srv__SetPen_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_turtlesim__srv__SetPen_Event(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  turtlesim__srv__SetPen_Event * ros_message = static_cast<turtlesim__srv__SetPen_Event *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_turtlesim__srv__SetPen_Event(cdr, ros_message);
}
