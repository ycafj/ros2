...
bool custom_interfaces__msg__coord__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("custom_interfaces.msg._coord.Coord", full_classname_dest, 34) == 0);
  }
  custom_interfaces__msg__Coord * ros_message = _ros_message;
  {  // x
...
PyObject * custom_interfaces__msg__coord__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("custom_interfaces.msg._coord");
